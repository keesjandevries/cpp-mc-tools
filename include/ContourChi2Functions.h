...
//NOTE: the correct interpretation of lux is with 90CL
//double lux131030_Sigma_pi_N_unc(double * , std::vector<int> & , std::vector<Contour*> &);
//double lux131030(double * , std::vector<int> & , std::vector<Contour*> &);
